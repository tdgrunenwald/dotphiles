...
source $HOME/.rye/shims/virtualenvwrapper_lazy.sh

export EDITOR=nvim
export TDGNVIMHOME="$HOME/.config/nvim/lua/tdg-nvim"

alias nrf24='nrfutil toolchain-manager launch --ncs-version v2.4.0 -- '
alias nrf26='nrfutil toolchain-manager launch --ncs-version v2.6.0 -- '
alias nrf27='nrfutil toolchain-manager launch --ncs-version v2.7.0 -- '
alias nrf='nrf27'
...
# Start tmux if available, but don't tmux inside tmux
